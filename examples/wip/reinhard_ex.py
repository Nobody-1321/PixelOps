...
img_src = pix.open_image("./data/img/room.jpg", mode = 'bgr')
img_tgt = pix.open_image("./data/img/sun.jpg", mode = 'bgr')


out_1 = reinhard_color_transfer_controlled(img_src, img_tgt, alpha_L=0.1, alpha_ab=0.5)
